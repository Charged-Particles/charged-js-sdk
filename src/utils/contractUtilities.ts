...
import sepoliaAddressImport from '@charged-particles/protocol-subgraph/networks/sepolia.json';
import modeAddressesImport from '@charged-particles/protocol-subgraph/networks/mode.json';
...
const sepolisAddress: NetworkContractLocations = sepoliaAddressImport;
const modeAddress: NetworkContractLocations = modeAddressesImport;
...
const getImportedContractLocations = (network: number) => {
  switch(network) {
    ...
    case 11155111: return sepolisAddress;
    case 34443: return modeAddress;
